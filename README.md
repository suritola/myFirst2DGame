...
| | |
|---|---|
| 🧙 **캐릭터 5종** | 거너 · 검사 · 도적 (기본) · 궁수 · 연금술사 (포인트 구매), 캐릭터마다 다른 평타 · 우클릭 · 특수 능력 8종, 10칸 도감 |
...
- **캐릭터**: 10칸 도감. 잠긴 캐릭터는 검은 실루엣과 ???, 누르면 거너 대비 스탯(체력 · 공격력 · 공격 속도 · 사거리 · 스킬 게이지 · 이동 속도)과 <선택> <취소>, 잠겼으면 <구매>. 포인트는 적을 처치할 때마다 쌓이고 저장됨
